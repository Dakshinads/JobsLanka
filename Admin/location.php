...
<html lang="en">
  <head>
    ...
    <title>Jobs Lanka Location</title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <h1 class="h2 mt-3">Location</h1></br>
    <div class="row">
      ...
      <div class='alert alert-success alert-dismissible collapse' role='alert' id="deleteDoneAlert">
        ...
        <div class="table-responsive" >
            <table class="table table-striped table-sm " data-show-columns="true" data-height="350" id="location" data-unique-id="id">
              <thead >
                <tr>
              ...
              <tbody>
                <?php 
                $sql= "select * from location where isactive=1";
...
<div class="modal fade" id="deleteDataModal" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">          
          <h5 class="modal-title">Location Delete</h5>
        </div>
        <form method="post" action="" class="needs-validation" novalidate>
        <div class="modal-body">
          <div class="col-12 mb-3">
...
if(isset($_POST['add'])){
  try{
    ...
    $sql = "insert into location(name,isactive) values ('$name',1)";
...
if(isset($_POST['deletem'])){
  try{
    $id=$_POST['did'];
    $sql="update location set isactive=0 where id=$id ";
    if(mysqli_query($con,$sql)){
      echo "<script>
