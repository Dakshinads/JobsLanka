    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">     
        <ul class="nav flex-column">
          ...
          <hr/>
          <li class="nav-item">
            <a class="nav-link active" href="myProfileM.php">
    ...
    <div class="row">
        <div class="modal-content">
            ...
            <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" id="jrole" name="jrole" disabled>
...
if(isset($_POST['updatem'])){
    try{
        ...
        $gender = $_POST['gender'];
        $cno = $_POST['cno'];
        $jrole = $_SESSION['userInfo']['job_role_id'];
        $email = $_POST['email'];        
        ...
        if(mysqli_query($con,$sql)){
          ...
          echo "<script>window.location.href='myProfileM.php';</script>";
        }else{
